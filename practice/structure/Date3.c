/*write a program to accept date and print it in format "month day,year" .check whether the date is valid or not .update the date 
 increment by 1 and print it . Modify the input function as it reads a value that in the form of long integer as 19450815 for the
 15-8-1945  */
...
struct date getdata(){
		...
		do{
			printf("\nEnter the date(YYYYMMDD): ");
			 i = scanf("%4d%2d%2d",&d1.year ,&d1.month, &d1.day);	//to check the enterd format is correct or not
